...
class MQTTClient:
    def __init__(self, device_id, cert, key):
        ...
        self.client.configureEndpoint("a3tzkr41x5sx31-ats.iot.us-east-1.amazonaws.com", 8883)
    ...
    def publish(self, Payload="payload"):
        ...
        self.client.subscribeAsync("hello/world", 0, ackCallback=self.customSubackCallback)
